...
function ListLession({ item, handleClicklession,handleShowLessionTitle ,index,showLessionTitle}) {

  return (
    <div className="cursor-pointer">
      <div className="mb-4" onClick={() => handleShowLessionTitle(index)}>
        <div className="flex items-center justify-between bg-gray-200 pl-3 pr-2 py-3 w-full rounded text-gray-600 font-bold cursor-pointer hover:bg-gray-300">
          ...
          {showLessionTitle ===index ? <span className="h-6 w-6 flex items-center justify-center text-teal-500">
            <svg
